# This script generates box plots sshowing methylation and chromatin 
#   accessibility of SINE and DNA transposons.
...
# Specify the two TE classes that are relevant for this analysis. These two 
# classes are enriched bith in skin Treg hypomethlation regions and in skin
# Treg hyperaccessibility peaks.
relevant_tes <- c("DNA", "SINE")
...
te_box_plot_pdf <- paste0(
  plot_outdir, 
  "/te_analysis_gen_loc_epigen_validation_sine_dna_conc_boxplot_meth.pdf"
)
te_box_plot_rds <- paste0(
  plot_rds_outdir, 
  "/te_analysis_gen_loc_epigen_validation_sine_dna_conc_boxplot_meth.rds"
)
...
# and element class. The normalised accessibility values are based on peaks that 
...
peaks_by_tes_outfile <- paste0(
  location, 
  "/te_analysis/gen_loc_epigen_validation_sine_dna_concordance_betw_meth_and_atac_boxplots_data_atac.txt"
)
...
te_box_plot_pdf <- paste0(
  plot_outdir, 
  "/te_analysis_gen_loc_epigen_validation_sine_dna_concord_boxplot_atac.pdf"
)
te_box_plot_rds <- paste0(
  plot_rds_outdir, 
  "/te_analysis_gen_loc_epigen_validation_sine_dna_concord_boxplot_atac.rds"
)
