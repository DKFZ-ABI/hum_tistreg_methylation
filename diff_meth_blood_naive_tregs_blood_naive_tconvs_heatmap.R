...
#   between blood naive Treg cells and blood naive Tconv cells.
...
signature_heatmap_outfile_pdf <- paste0(plot_outdir,
                                        "/diff_meth_blood_naive_treg_blood_naive_tconv_heatmap.pdf")
signature_heatmap_outfile_rds <- paste0(plot_rds_outdir,
                                        "/diff_meth_blood_naive_treg_blood_naive_tconv_heatmap.rds")
signature_heatmap_rowanno_outfile_rds <- paste0(
  plot_rds_outdir,
  "/diff_meth_blood_naive_treg_blood_naive_tconv_heatmap_rowanno_dfs.rds"
)
signature_heatmap_colanno_outfile_rds <- paste0(
  plot_rds_outdir,
  "/diff_meth_blood_naive_treg_blood_naive_tconv_heatmap_colanno_dfs.rds"
)
