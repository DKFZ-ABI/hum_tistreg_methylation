...
signature_heatmap_outfile_pdf <- paste0(
  plot_outdir, "/diff_acc_blood_naive_tconv_blood_naive_treg_heatmap.pdf")
signature_heatmap_outfile_rds <- paste0(
  plot_rds_outdir, "/diff_acc_blood_naive_tconv_blood_naive_treg_heatmap.rds")
...
signature_heatmap_outfile_pdf <- paste0(
  plot_outdir, 
  "/diff_acc_blood_naive_tconv_blood_naive_treg_heatmap_by_donor.pdf"
)
signature_heatmap_outfile_rds <- paste0(
  plot_rds_outdir, 
  "/diff_acc_blood_naive_tconv_blood_naive_treg_heatmap_by_donor.rds"
)
pdf(signature_heatmap_outfile_pdf, width = 9, height = 10)
eval(parse(text = heatmap_drawing_string))
dev.off()
