...
#   chromatin accessibility of all TEs and LTR, SINE, LINE and DNA insertion 
...
rmsk_filt_classes <- do.call(
  ...
  lapply(c("LINE", "DNA", "SINE", "LTR"), FUN = function(x) {
    temp_df <- rmsk_filt[rmsk_filt$V12 == x, ]
...
avg_raw_meth_outfile <- paste0(
  location, 
  "/te_analysis/gen_loc_all_plus_ltr_sine_line_dna_vio_plot_skin_bloodccr8_bloodnaive_data_meth.txt"
)
...
te_violin_plot_pdf <- paste0(
  plot_outdir, 
  "/te_analysis_gen_loc_all_plus_ltr_sine_line_dna_vio_plot_skin_bloodccr8_bloodnaive_violinplot_meth.pdf"
)
te_violin_plot_rds <- paste0(
  plot_rds_outdir, 
  "/te_analysis_gen_loc_all_plus_ltr_sine_line_dna_vio_plot_skin_bloodccr8_bloodnaive_violinplot_meth.rds"
)
pdf(te_violin_plot_pdf, width = 7, height = 10)
...
dot_plot_data <- do.call(rbind, lapply(cell_types, FUN = function(x) {
  ...
  this_celltype_df <- do.call(
    rbind, 
    lapply(unique(avg_raw_meth_df_melted$overall_category), FUN = function(y) {
      this_class_df <- do.call(rbind, lapply(corresp_samp, FUN = function(z) {
        meth_vals <- avg_raw_meth_df[avg_raw_meth_df$overall_category == y, z]
...
dot_plot_meth_pdf <- paste0(
  plot_outdir, 
  "/te_analysis_gen_loc_all_plus_ltr_sine_line_dna_vio_plot_skin_bloodccr8_bloodnaive_violinplot_meth_related_dotplot.pdf"
)
dot_plot_meth_rds <- paste0(
  plot_rds_outdir, 
  "/te_analysis_gen_loc_all_plus_ltr_sine_line_dna_vio_plot_skin_bloodccr8_bloodnaive_violinplot_meth_related_dotplot.rds"
)
pdf(dot_plot_meth_pdf, width = 3, height = 8)
...
ridge_plot_data <- do.call(rbind, lapply(cell_type_comps, FUN = function(comp) {
  ...
  this_comp_data <- do.call(
    rbind, 
    lapply(unique(avg_raw_meth_df$overall_category), FUN = function(x) {
      corresp_df <- avg_raw_meth_df[avg_raw_meth_df$overall_category == x, ]
      meth_diffs <- do.call(
        rbind, 
...
te_counts$y_pos <- rep(
  ...
  each = 2 * length(unique(avg_raw_meth_df$overall_category))
)
...
ridge_plot_meth_pdf <- paste0(
  plot_outdir, 
  "/te_analysis_gen_loc_all_plus_ltr_sine_line_dna_vio_plot_skin_bloodccr8_bloodnaive_violinplot_meth_related_ridgeplot.pdf"
)
ridge_plot_meth_rds <- paste0(
  plot_rds_outdir, 
  "/te_analysis_gen_loc_all_plus_ltr_sine_line_dna_vio_plot_skin_bloodccr8_bloodnaive_violinplot_meth_related_ridgeplot.rds"
)
pdf(ridge_plot_meth_pdf, width = 7, height = 10)
...
################################################################################
# Generate violin plots of normalised acessibility stratified by donor and cell 
...
peaks_by_tes <- do.call(rbind, lapply(
  unique(rmsk_filt_2_gr$overall_category), 
  FUN = function(x) {
...
peaks_by_tes_outfile <- paste0(
  location, 
  "/te_analysis/gen_loc_all_plus_ltr_sine_line_dna_vio_plot_skin_bloodccr8_bloodnaive_data_atac.txt"
)
...
te_violin_plot_pdf <- paste0(
  plot_outdir, 
  "/te_analysis_gen_loc_all_plus_ltr_sine_line_dna_vio_plot_skin_bloodccr8_bloodnaive_violinplot_atac.pdf"
)
te_violin_plot_rds <- paste0(
  plot_rds_outdir, 
  "/te_analysis_gen_loc_all_plus_ltr_sine_line_dna_vio_plot_skin_bloodccr8_bloodnaive_violinplot_atac.rds"
)
...
# acrosss the TE-overlapping peaks.
...
dot_plot_atac_pdf <- paste0(
  plot_outdir, 
  "/te_analysis_gen_loc_all_plus_ltr_sine_line_dna_vio_plot_skin_bloodccr8_bloodnaive_violinplot_atac_related_dotplot.pdf"
)
dot_plot_atac_rds <- paste0(
  plot_rds_outdir, 
  "/te_analysis_gen_loc_all_plus_ltr_sine_line_dna_vio_plot_skin_bloodccr8_bloodnaive_violinplot_atac_related_dotplot.rds"
)
pdf(dot_plot_atac_pdf, width = 3, height = 8)
...
########## Related diagram 2: 
# For each TE-overlapping peak and each combination of two cell types, 
# the difference between mean accessibility in each cell type is computed. The 
# distribution of those differences is shown by a ridge plot.
...
ridge_plot_atac_pdf <- paste0(
  plot_outdir, 
  "/te_analysis_gen_loc_all_plus_ltr_sine_line_dna_vio_plot_skin_bloodccr8_bloodnaive_violinplot_atac_related_ridgeplot.pdf"
)
ridge_plot_atac_rds <- paste0(
  plot_rds_outdir, 
  "/te_analysis_gen_loc_all_plus_ltr_sine_line_dna_vio_plot_skin_bloodccr8_bloodnaive_violinplot_atac_related_ridgeplot.rds"
)
pdf(ridge_plot_atac_pdf, width = 7, height = 10)
