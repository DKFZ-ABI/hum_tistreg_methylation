# This script generates an additional track plot for a region in IL2RA.
...
region_to_plot <- GRanges(seqnames = "10",
                          ranges = IRanges(start = 6098000,
                                           end = 6103252))
...
plot_meth_and_other_signal_many_regions_custom_titles_custom_highlight_many_cell_types(
  ...
  outfile_pdf = paste0(
    plot_outdir, 
    "/diff_meth_diff_acc_diff_gex_naivetconv_naivetreg_dmr_peak_gene_links_trackplots_additional_il2ra_region.pdf"
  ),
  ncores = 1
)
