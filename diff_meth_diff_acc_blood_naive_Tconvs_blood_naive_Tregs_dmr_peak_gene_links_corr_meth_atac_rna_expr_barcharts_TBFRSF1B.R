# This script generates an expression bar chart for TNFRSF1B from the
#   comparison between blood naive Treg cells and blood naive Tconv cells.
...
# blood naive Tconvs.
relevant_cell_types <- c("Blood_naive_Treg", "Blood_naive_Tconv")
