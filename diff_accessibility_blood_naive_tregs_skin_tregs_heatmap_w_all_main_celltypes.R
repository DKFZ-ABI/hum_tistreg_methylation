...
#   cells, also visualising the other main cell types shown in our manuscript.
...
signature_heatmap_outfile_pdf <- paste0(
  plot_outdir,
  "/diff_acc_skin_treg_blood_naive_treg_heatmap_w_other_published_celltypes.pdf"
)
signature_heatmap_outfile_rds <- paste0(
  plot_rds_outdir,
  "/diff_acc_skin_treg_blood_naive_treg_heatmap_w_other_published_celltypes.rds"
)
...
signature_heatmap_outfile_pdf <- paste0(
  plot_outdir,
  "/diff_acc_skin_treg_blood_naive_treg_heatmap_w_other_published_celltypes_by_donor.pdf"
)
signature_heatmap_outfile_rds <- paste0(
  plot_rds_outdir,
  "/diff_acc_skin_treg_blood_naive_treg_heatmap_w_other_published_celltypes_by_donor.rds"
)
pdf(signature_heatmap_outfile_pdf,
    width = 12,
    height = 10)
