...
#   track plots for blood CCR8+ Treg cell positioning regarding DMR-peak-gene 
#   links.
...
genes_to_plot <- c("BATF", "CCR6", "PREX1", "SPRED2", "TMEM154", "TOX", "VAV3")
...
for (gene in genes_to_plot) {
  ...
  expr_plot_pdf <- paste0(plot_outdir, 
                          "/skin_treg_blood_ccr8_treg_blood_naive_treg_expr_",
                          gene,
                          ".pdf")
