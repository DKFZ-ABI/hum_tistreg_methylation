...
# Add the custom FOXP3 and IL2RA regions shown in the manuscript.
custom_foxp3_region <- GRanges(seqnames = "X",
                               ranges = IRanges(start = 49114000,
                                                end = 49124000))
custom_il2ra_region <- GRanges(seqnames = "10",
                               ranges = IRanges(start = 6098000,
                                                end = 6103252))
overl_gr <- c(overl_gr, custom_foxp3_region, custom_il2ra_region)
...
heatmap_pdf <- paste0(
  plot_outdir, 
  "/dmr_peak_gene_links_blood_naive_tconv_blood_naive_treg_meth_heatmmaps_for_trackplots.pdf"
)
heatmap_rds <- paste0(
  plot_rds_outdir, 
  "/dmr_peak_gene_links_blood_naive_tconv_blood_naive_treg_meth_heatmmaps_for_trackplots.rds"
)
