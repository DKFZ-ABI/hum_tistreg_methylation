...
#   between skin Treg cells and blood naive Treg cells, also showing fat Treg
#   cells.
...
relevant_cell_types <- c("Skin Treg", "Blood naive Treg", "Fat Treg")
...
cell_type_col_palette <- c("blue", "darkorchid1", "green")
...
signature_heatmap_outfile_pdf <- paste0(
  plot_outdir,
  "/treg_hierarchies_diff_meth_skin_treg_blood_naive_treg_heatmap_w_fat_treg.pdf"
)
signature_heatmap_outfile_rds <- paste0(
  plot_rds_outdir,
  "/treg_hierarchies_diff_meth_skin_treg_blood_naive_treg_heatmap_w_fat_treg.rds"
)
signature_heatmap_rowanno_outfile_rds <- paste0(
  plot_rds_outdir,
  "/treg_hierarchies_diff_meth_skin_treg_blood_naive_treg_heatmap_w_fat_treg_rowanno_dfs.rds"
)
signature_heatmap_colanno_outfile_rds <- paste0(
  plot_rds_outdir,
  "/treg_hierarchies_diff_meth_skin_treg_blood_naive_treg_heatmap_w_fat_treg_colanno_df.rds"
)
