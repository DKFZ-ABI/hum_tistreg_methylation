# This script generates violin plots and related diagrams for methyation of LTR, 
#   SINE and DNA insertion sites for skin Treg cells, fat Treg cells and blood 
#   CD45RA+ Treg cells.
...
avg_raw_meth_outfile <- paste0(
  location, 
  "/te_analysis/gen_loc_ltr_sine_dna_vio_plot_skin_fat_bloodnaive_data_meth.txt"
)
...
te_violin_plot_pdf <- paste0(
  plot_outdir, 
  "/te_analysis_gen_loc_ltr_sine_dna_skin_fat_bloodnaive_violinplot_meth.pdf"
)
te_violin_plot_rds <- paste0(
  plot_rds_outdir, 
  "/te_analysis_gen_loc_ltr_sine_dna_skin_fat_bloodnaive_violinplot_meth.rds"
)
...
dot_plot_meth_pdf <- paste0(
  plot_outdir, 
  "/te_analysis_gen_loc_ltr_sine_dna_skin_fat_bloodnaive_violinplot_meth_related_dotplot.pdf"
)
dot_plot_meth_rds <- paste0(
  plot_rds_outdir, 
  "/te_analysis_gen_loc_ltr_sine_dna_skin_fat_bloodnaive_violinplot_meth_related_dotplot.rds"
)
...
cell_type_comps <- do.call(
  c, 
  lapply(1:(length(cell_types) - 1), FUN = function(x) {
...
ridge_plot_meth_pdf <- paste0(
  plot_outdir, 
  "/te_analysis_gen_loc_ltr_sine_dna_skin_fat_bloodnaive_violinplot_meth_related_ridgeplot.pdf"
)
ridge_plot_meth_rds <- paste0(
  plot_rds_outdir, 
  "/te_analysis_gen_loc_ltr_sine_dna_skin_fat_bloodnaive_violinplot_meth_related_ridgeplot.rds"
)
