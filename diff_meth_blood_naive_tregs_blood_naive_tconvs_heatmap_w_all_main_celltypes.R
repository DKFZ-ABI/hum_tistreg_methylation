...
#   between blood naive Treg cells and blood naive Tconv cells, also showing the 
#   other main cell types that appear in our publication.
...
cell_type_col_palette <- c("darkorchid1", "red", "blue", "cyan2", "orange")
...
signature_heatmap_outfile_pdf <- paste0(
  plot_outdir, 
  "/diff_meth_blood_naive_treg_blood_naive_tconv_heatmap_w_other_published_celltypes.pdf"
)
signature_heatmap_outfile_rds <- paste0(
  plot_rds_outdir, 
  "/diff_meth_blood_naive_treg_blood_naive_tconv_heatmap_w_other_published_celltypes.rds"
)
signature_heatmap_rowanno_outfile_rds <- paste0(
  plot_rds_outdir, 
  "/diff_meth_blood_naive_treg_blood_naive_tconv_heatmap_w_other_published_celltypes_rowanno_dfs.rds"
)
signature_heatmap_colanno_outfile_rds <- paste0(
  plot_rds_outdir, 
  "/diff_meth_blood_naive_treg_blood_naive_tconv_heatmap_w_other_published_celltypes_colanno_dfs.rds"
)
