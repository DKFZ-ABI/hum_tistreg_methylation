...
#   expressed between blood naive Tconv cells and blood naive Treg cells.
...
signature_heatmap_outfile_pdf <- paste0(
  plot_outdir, "/diff_expr_blood_naive_tconv_blood_naive_treg_heatmap.pdf")
signature_heatmap_outfile_rds <- paste0(
  plot_rds_outdir, "/diff_expr_blood_naive_tconv_blood_naive_treg_heatmap.rds")
